...
query BillingAgreementContextQueryForAddCard($billingAgreementId: String!, $billingAgreementOptions: billingbillingAgreementContextInput) {
  billing {
    billingAgreementContext(billingAgreementId: $billingAgreementId, billingAgreementOptions: $billingAgreementOptions) {
      billingAgreementToken
      type
      merchant {
        name
